        ...
        if now_t - lastchg_t > min_change_interval then
            ...
            if reflector_list then
                ...
                if cur_rx_bytes and cur_tx_bytes and up_del_stat and down_del_stat then
                    ...
                    if up_del_stat and up_del_stat < max_delta_owd and tx_load > high_load_level then
                    ...
                    if down_del_stat and down_del_stat < max_delta_owd and rx_load > high_load_level then
