...
#
# Original file from https://github.com/richb-hanover/OpenWrtScripts#getstatssh
# MODIFIED FOR SQM-AUTORATE to include "tc" commands - 29Dec2021
#
...
uname -a
uptime
tc -s qdisc | grep bandwidth
tc -s qdisc | grep capacity
